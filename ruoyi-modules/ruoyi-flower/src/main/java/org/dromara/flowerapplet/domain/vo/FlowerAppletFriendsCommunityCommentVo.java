...
@AutoMapper(target = FlowerAppletFriendsCommunityComment.class)
public class FlowerAppletFriendsCommunityCommentVo implements Serializable {
     ...
     * 评论的子级
     */
    private List<FlowerAppletFriendsCommunityCommentVo> replies = new ArrayList<>();
}
