...
public class AuthController {
     ...
     */
    @GetMapping("/isLogin")
    public R<LoginStatus> isLogin(){
        log.info("是否登录:{},{},{}", StpUtil.getLoginId(),StpUtil.getTokenValue());
        if(StpUtil.isLogin()){
            return R.ok(new LoginStatus("true","已登录"));
        }
        return R.ok(new LoginStatus("false","未登录"));
    }
